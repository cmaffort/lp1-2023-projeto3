    ...
    <head>
     ...
     <header id="header-main">
            ...
            <div>
                ...
                <p style="font-family: 'Alegreya SC'; padding-left: 5vw;">GERENTE</p>
        ...
        <ul>
            <li>
                <a href="cadastroFuncionario.jsp" style="color: white;text-decoration: none">
                <img src="../../imagens/funcionarios.png" style="height: 35px;padding-top: 1.5cm;">
                <p>Funcionários</p>
                </a>
            </li>
            <li>
                <a href="../passageiro/Cadastro.jsp" style="color: white;text-decoration: none">
            ...
            <li>
                ...
                <img src="../../imagens/produtos.png" style="height: 35px;padding-top: 1.5cm;">
                <p>Produtos</p>
                <a>
