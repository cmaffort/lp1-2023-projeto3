         ...
         <div id='setor-admissao'>
                ...
                <div id="nome-telefone">
                           <p>
                            ...
                            <input  onChange="handleFile(this.files)" type='text' id="dataNascimentoFuncionario"  name='dataNascimento' value='' required>
                            ...
                            <p>
                             ...
                             <label class="mov" for="estadoCivilFuncionario" style="font-family: 'Alegreya SC';">Estado Civil:</label>
                              <input type='text' onChange="handleFile(this.files)" name='estadoCivil' id="civilFuncionario" data-ls-module="charCounter" maxlength="13" required> 
                            </p>
                           <p>
                             ...
                             <input type='text' onChange="handleFile(this.files)" name='rg' id="rgFuncionario" data-ls-module="charCounter" maxlength="13" required>   
                              <label class="mov" for="sexoFuncionario" style="font-family: 'Alegreya SC';">Sexo:</label>
                               <input type='text' onChange="handleFile(this.files)" name='sexo' id="sexoFuncionario" data-ls-module="charCounter" maxlength="13" required> 
