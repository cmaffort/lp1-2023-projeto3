...
let cartoesParaConfirmar = document.querySelectorAll(".novoCartao");
let partesSuperiores = document.querySelectorAll(".parte-superior div:nth-of-type(2)");
let disposicaoNumero = document.querySelector("#teste-cartao div:nth-of-type(2)");
let divConfirma = document.querySelector("#teste-cartao");

divConfirma.style.display = "none";

for (let i = 0; i < cartoesParaConfirmar.length; i++) {
    let num = partesSuperiores[i].innerHTML;
    cartoesParaConfirmar[i].addEventListener("click", () => {
       disposicaoNumero.innerHTML = num;
